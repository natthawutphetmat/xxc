...
const ToolPageGoogle = () => {
    ...
    return (
        <>
        <head>
          <title>ดาวน์โหลดเครื่องมือทำการตลาดฟรี Dowloads Google</title>
          <meta name="description" content="ดาวน์โหลดเครื่องมือทำการตลาดฟรี Dowloads Landing page Google" />
