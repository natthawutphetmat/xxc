...
function ToolPage() {
  return (
    <>
         ...
         <title>รับทำโฆษณาออนไลน์ Google Google, Facebook Ads สายเทาเพื่อธุรกิจของคุณ</title>
      ...
      <div className="container text-center">
        ...
        <Image src="/img/head1.webp"  width={800} height={300}  alt="ทำการตลาดฟรี" className="header-image" />
      </div>
      ...
      <Image src="/img/fbgg.webp" width={800} height={300}  alt="ทำการตลาดฟรี" className="header-image" />
